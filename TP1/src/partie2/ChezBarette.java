...
public class ChezBarette {
	...
	public ChezBarette(){
		...
		try {
			...
			//tant que le fichier text n'est pas terminé et que la facture est valide
			while ( (ligne = fic.readLine() ) != null && valide ){
				...
				if ( !ligne.equals("Clients:") && !ligne.equals("Plats:") && !ligne.equals("Commandes:") && !ligne.equals("Fin")){
					...
					//le status va permettre de changer d'instruction selon où nous somme rendu dans le fichier 
	...
	public boolean verifierCommande(String commande){
		...
		// On verifie si il y a bien 3 entrées ( laCommande[0] = nom, [1]=repas [2]= nb de plats)
